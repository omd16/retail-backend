...
public class UserAddressService {
    ...
    public UserAddressService(UserRepository userRepository, UserAddressRepository addressRepository, UserAddressMapper addressMapper) {
    ...
    public List<UserAddress> getUserAddressDetails(UUID userId){
        return Optional.ofNullable(addressRepository.findByUserId(userId)).orElseGet(List::of).stream().map(addressMapper::map).toList();
    }
