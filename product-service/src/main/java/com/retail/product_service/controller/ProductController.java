...
public class ProductController {
  ...
  public ResponseEntity<Page<ProductResponseDto>> getAll(
      ProductSearchParameter parameter, Pageable pageable) throws InterruptedException {
  ...
  @PostMapping("/all")
  public ResponseEntity<List<ProductResponseDto>> createAllProduct(
      @RequestBody List<ProductRequestDto> dto) {
    return ResponseEntity.ok(productService.saveAll(dto));
  }

  @PutMapping("/{id}")
  public ResponseEntity<ProductResponseDto> updateProduct(
      @RequestBody ProductRequestDto dto, @PathVariable Long id) {
    return ResponseEntity.ok(productService.update(dto, id));
  }

  @PatchMapping("/{id}")
  public ResponseEntity<ProductResponseDto> patchProduct(
      @Validated(ProductRequestDto.OnProductPatch.class) @RequestBody ProductRequestDto dto,
