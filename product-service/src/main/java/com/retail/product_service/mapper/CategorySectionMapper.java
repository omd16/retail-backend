...
public interface CategorySectionMapper {
    ...
    CategorySection toEntity(CategorySectionRequestDTO dto, List<CategorySectionItem> items, @Context CategorySectionMapperContext ctx);
    ...
    @Mapping(target = "items", source = "items")
    void updateSection(@MappingTarget CategorySection categorySection, CategorySectionRequestDTO dto, List<CategorySectionItem> items, @Context CategorySectionMapperContext ctx);
}
