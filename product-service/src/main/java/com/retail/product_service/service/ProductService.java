...
public class ProductService {
    ...
    public ProductService(ProductRepository productRepository, CategoryRepository categoryRepository, ProductMapper productMapper, ProductSpecMapper productSpecMapper) {
    ...
    public ProductResponseDto update(ProductRequestDto dto, Long id){
        var product = productRepository.findById(id).orElseThrow(() -> new NotFoundException("No product found for given id"));
